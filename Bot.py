...
async def on_member_join(member):
    ...
    try:
        message = await channel.send(content="𝙷𝚞𝚖𝚊𝚗𝚒𝚝𝚢 𝚠𝚒𝚕𝚕 𝙴𝙽𝙳 𝚜𝚘𝚘𝚗. 𝚃𝚘 𝚊𝚟𝚘𝚒𝚍 𝚝𝚑𝚎 𝙴𝙽𝙳, 𝚢𝚘𝚞𝚛 𝚌𝚘𝚘𝚙𝚎𝚛𝚊𝚝𝚒𝚘𝚗 𝚒𝚜 𝚗𝚎𝚎𝚍𝚎𝚍.\n\n__Welcome Summoner <@%d> to 𝕊𝕠𝕦𝕝 ℍ𝕒𝕔𝕜𝕖𝕣𝕤 𝟚ꕯ__ \n__Please make sure to read <#953856487330050059> and enjoy your stayꕯ__"%member.id,file=discord.File('output.png'), delete_after = 360)
    except:
